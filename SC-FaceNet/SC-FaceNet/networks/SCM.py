...
class SCM(nn.Module):
    def __init__(self, op_channel: int, group_num: int = 16, gate_treshold: float = 0.5, alpha: float = 1 / 2,
        ...
        self.SRU = SCU(op_channel, group_num=group_num, gate_treshold=gate_treshold)
        self.CRU = CCU(op_channel, alpha=alpha, squeeze_radio=squeeze_radio, group_size=group_size,
